...
// .wrangler/tmp/pages-MDhgzC/functionsWorker-0.1585622012863619.mjs
var __defProp2 = Object.defineProperty;
var __name2 = /* @__PURE__ */ __name((target, value) => __defProp2(target, "name", { value, configurable: true }), "__name");
var CIRCLE_API = "https://api.circle.com/v1/w3s";
...
__name(circlePost, "circlePost");
__name2(circlePost, "circlePost");
...
var CIRCLE_API2 = "https://api.circle.com/v1/w3s";
async function circleReq(method, path, body, apiKey, userToken) {
  ...
  const res = await fetch(`${CIRCLE_API2}${path}`, {
    method,
    headers,
...
__name(circleReq, "circleReq");
__name2(circleReq, "circleReq");
async function onRequestPost2(ctx) {
  ...
  if (action === "balance") {
    const data = await circleReq("GET", "/user/wallets", void 0, apiKey, userToken);
    return new Response(JSON.stringify(data), {
      headers: { "Content-Type": "application/json", "Access-Control-Allow-Origin": "*" }
    });
  }
...
// .wrangler/tmp/bundle-rRgVfI/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-rRgVfI/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.1585622012863619.js.map

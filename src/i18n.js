...
const EN = {
  ...
  'Lưu vào kho QR': 'Save to QR Library',
  ...
  'Chuyển tiền qua QR hoặc địa chỉ ví': 'Send money via QR code or wallet address',
  'Hiện mã QR để nhận tiền': 'Show your QR code to receive money',
  'Đổi giữa USDC, EURC, cirBTC': 'Swap between USDC, EURC, and cirBTC',
  'Loại': 'Type',
  ...
  'Swap (sắp ra mắt)': 'Swap (coming soon)',
}

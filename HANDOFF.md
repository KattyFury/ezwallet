...
- **Numpad = hàng 6.5–8.5** (`gridRow 6/9`, spacer 0.5 + Numpad 2.5), nút Back/Continue riêng ở `.row10-dual` (SendAmount, CreateQR). **Riêng Swap (07-20):** bấm SỐ TIỀN card "You pay" → bottom-sheet `.sheet-overlay/.sheet` trượt từ dưới lên (như PIN); layout TRONG sheet Y CHANG SendAmount (user chốt "đồng bộ giao diện"): sheet = nửa dưới màn 50dvh, spacer 0.75 + Numpad 2.5 + đệm 0.75 + hàng nút Back/Done pill 44% (chuẩn .row10-dual, không thêm gì khác). Gõ live cập nhật số + pct + estimate; Back = hủy số vừa gõ (khôi phục như trước khi mở), Done/nền tối = giữ; slider + chip gợi ý giữ nguyên.

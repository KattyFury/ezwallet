...
- **Swap** USDC↔EURC↔cirBTC – BẬT, verify eth_simulateV1 đạt + **user test TIỀN THẬT trên deploy OK (07-18)**. Màn Swap = thanh trượt % (5 mốc 0/25/50/75/100, nam châm ±2%) + chip gợi ý số chẵn (`roundHint.js`, test `node test/roundHint.test.mjs` **19/19**). **Luật gợi ý = "phương án A" (user chốt 08-04), KHÔNG còn bộ ba sàn·sàn+0.5·trần của 07-17e:** bước làm tròn co giãn theo độ lớn `u = 10^floor(log10(số))/2` ⇒ 7,35 → 7·7,5·8 · 24,4 → 20·25·30 · 39.000 → 35k·40k·45k.

...
**Cập nhật:** 2026-07-06 (session 21 — 8 UX: login nút về h9-10, PinGate căn giữa h1-5, nút Swap tự hiện trạng thái, caret `_` ô nhập số, Swap cụm to liền numpad, Hold-token giữa h6 + list h3-5, QR Library back xanh/phải, icon token PNG)

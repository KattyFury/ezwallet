...
- **Danh sách câu hỏi bảo mật trong dropdown (vd "What is your father's middle name?") vẫn tiếng Anh** — đây là bộ câu hỏi MẶC ĐỊNH của Circle, muốn đổi phải tự soạn bộ câu hỏi tiếng Việt riêng rồi truyền qua `setCustomSecurityQuestions({ questions: [...] })` (khác hẳn việc dịch nhãn). CHƯA làm vì cần user chọn nội dung câu hỏi, không tự bịa.
